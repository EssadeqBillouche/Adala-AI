...
export default function CaseSidebar({
  ...
  return (
    <aside className="w-80 bg-surface-container-low border-l border-surface-container-high p-6 overflow-y-auto">
      <div>
        <Label variant="muted" className="mb-1">REFERENCE</Label>
        ...
        <TonalCard className="p-5 mb-6" hover={false}>
          ...
          <p className="body-sm text-gray-600">{summary}</p>
        </TonalCard>
