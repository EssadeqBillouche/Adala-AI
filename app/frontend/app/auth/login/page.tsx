    ...
    <div className="min-h-screen bg-surface flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="display-lg text-on-primary mb-6">
            Welcome to <span className="italic">Majlis Digital</span>
          </h1>
          <p className="body-lg text-on-primary/90 mb-8">
            Your gateway to Moroccan legal excellence. Access AI-powered legal intelligence, 
            manage your cases, and explore comprehensive legal resources.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-on-primary/90">
              ...
              <span>AI-powered legal consultation</span>
            </div>
            <div className="flex items-center gap-3 text-on-primary/90">
              <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span>Comprehensive Moroccan legal database</span>
            </div>
            <div className="flex items-center gap-3 text-on-primary/90">
              <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="headline-md mb-2">Sign in to your account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="body-sm text-gray-600">Remember me</span>
              </label>
              <Link 
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-surface label-sm text-gray-500">Or continue with</span>
            </div>
          </div>
          ...
          <p className="mt-8 text-center body-sm text-gray-500">
            ...
            <Link href="/auth/signup" className="text-secondary hover:text-secondary-container font-semibold transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
